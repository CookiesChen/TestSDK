...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Cookieschen/TestSDK'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Cookieschen' => '1109349604@qq.com' }
  s.source           = { :git => 'https://github.com/Cookieschen/TestSDK.git', :tag => s.version.to_s }
